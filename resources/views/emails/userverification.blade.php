        ...
        <table style="width: 100%; height: 200px;">
            ...
            <tr >
                <td style=" text-align: center; padding-top: 20px;">
                    <a href="{{ route("verifyemailuser", ["token"=>$mailData['token']]) }}" style=" background-color: #DA1F1A; padding: 20px; text-decoration: none; color: white; border-radius: 10px;" >Verify Email</a>
                </td>
            </tr>
        </table>
    </div>
